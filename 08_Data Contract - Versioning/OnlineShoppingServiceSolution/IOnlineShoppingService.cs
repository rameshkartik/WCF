...
namespace Rameshkartik.WCFSamples.OnlineShoppingService.Contracts
{
    ...
    public interface IOnlineShoppingService
    {
        ...
        ArrayList GetProductsAvailableinStores(string iModelNumber, int iQuantity, string sDeliveryLocation);                                                                  // return type change

        [OperationContract(Name = "CheckDiscountAmount_NewMethod")]
        double CheckDiscountAmount_NewMethod(string iModelNumber, int iQuantity, string sDeliveryLocation);                                                                 // new method
