            ...
            switch (sFilterByCity)
            {
                case "Chennai":
                    if (sFilterByCity.Equals("Chennai"))
                    {
                        ...
                        WholeSaleDealersInfo wsDealer = new WholeSaleDealersInfo();
                        wsDealer.DealerName = "Rameshkartik";
                        wsDealer.DealerLocation = "Chennai";
                        wsDealer.DealerAge = 28;
                        wsDealer.DealerSince = DateTime.Now;
                        return wsDealer;
                    }
                    break;
